...
// Filter the results based on the selected display type
$filteredThesis = array_filter($filteredThesis, function($thesis) use ($displayType) {
    return isset($thesis[$displayType . '-preview']);
});
